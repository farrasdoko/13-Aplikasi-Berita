...
// declare variable for nampung data
    ...
    override func viewDidLoad() {
        ...
        let url = "http://localhost/ServerBerita/index.php/DataGuru/getBeritaByIdKategori"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let isi_Berita = serverid["isi_berita"]
        //print(judul)
        var gambar = serverid["gambar"]
        
        //move label
        cell.labelJudul.text = judul
        cell.labelIsi.text = isi_Berita
